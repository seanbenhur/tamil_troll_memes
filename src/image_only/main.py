...
from models import Resnet, Resnet101, Image_Classifier 
...
if training_args.scheduler == "onecycle":
    ...
    raise RuntimeError(
            f"Invalid lr scheduler '{args.lr_scheduler}'. Only Onecycle,LinearLR,CosineLR, StepLR, CosineAnnealingLR and ExponentialLR "
            "are supported."
        )
